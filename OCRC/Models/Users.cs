...
namespace OCRC.Models
{
    public class Users
    {
        ...
        {
            using (var cn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Truong\Documents\ORC.mdf;Integrated Security=True;Connect Timeout=30"))
            {
